/*
  ...
  sequence of fake random height for HW5 in CSE2010.  The sequence has
  31 numbers: 0 occurs 16 times, 1 occurs 8 times, 2 occurs 4 times, 3
  occurs 2 time, and 4 occurs 1 time.  Each number is returned by
  get() in the following order and the numbers are recycled if get()
  is called more than 31 times.
