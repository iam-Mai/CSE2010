...
/*
  ...
  Description of the TrieNode algorithm:
        ...
        parent, children, character, isLeaf, isWord, isGuess, frequence, childrenHash
*/

public class TrieNode {
   private TrieNode parent;     //parent node of this node
   private TrieNode[] children; //all children node of this node
   public Map<Integer, TrieNode> childrenHash = new HashMap<>();    //Store frequence as a key and TrieNode as a value
   public char character;      //Data stores in this node
   ...
   public TrieNode addWord(String word, int p) {
      isLeaf = false;
      isGuess = false;
   ...
   public void hash() {
      TrieNode p = this;
      while(p.parent != null) {
          p.parent.childrenHash.put(this.frequence, this);
          //p.children = new TrieNode[0];
          p = p.parent;
      }
   }
